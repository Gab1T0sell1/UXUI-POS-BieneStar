...
function openConfirmModal() {
  ...
  const TRANSLATIONS = {
    es: {
      dir: 'ltr',
      pageLabels: { dashboard:'Inicio', inventario:'Inventario', historial:'Historial de Ventas', ventas:'Registrar Venta', proveedores:'Proveedores', usuarios:'Usuarios', reportes:'Reportes', configuracion:'Configuración' },
      nav: ['Inicio','Registrar Venta','Inventario','Proveedores','Historial de Ventas','Usuarios','Reportes','Configuración'],
    ...
    'es-es': {
      dir: 'ltr',
      pageLabels: { dashboard:'Inicio', inventario:'Inventario', historial:'Historial de ventas', ventas:'Registrar venta', proveedores:'Proveedores', usuarios:'Usuarios', reportes:'Informes', configuracion:'Configuración' },
      nav: ['Inicio','Registrar venta','Inventario','Proveedores','Historial de ventas','Usuarios','Informes','Configuración'],
      sections: ['Principal','Inventario','Gestión'],
    ...
    en: {
      dir: 'ltr',
      pageLabels: { dashboard:'Dashboard', inventario:'Inventary', historial:'Sales History', ventas:'Register Sale', proveedores:'Suppliers', usuarios:'Users', reportes:'Reports', configuracion:'Settings' },
      nav: ['Dashboard','Register Sale','Inventary','Suppliers','Sales History','Users','Reports','Settings'],
    ...
    pt: {
      dir: 'ltr',
      pageLabels: { dashboard:'Início', inventario:'Inventário', historial:'Histórico de Vendas', ventas:'Registrar Venda', proveedores:'Fornecedores', usuarios:'Usuários', reportes:'Relatórios', configuracion:'Configurações' },
      nav: ['Início','Registrar Venda','Inventário','Fornecedores','Histórico de Vendas','Usuários','Relatórios','Configurações'],
    ...
    de: {
      dir: 'ltr',
      pageLabels: { dashboard:'Übersicht', inventario:'Inventar', historial:'Verkaufsverlauf', ventas:'Verkauf erfassen', proveedores:'Lieferanten', usuarios:'Benutzer', reportes:'Berichte', configuracion:'Einstellungen' },
      nav: ['Übersicht','Verkauf erfassen','Inventar','Lieferanten','Verkaufsverlauf','Benutzer','Berichte','Einstellungen'],
